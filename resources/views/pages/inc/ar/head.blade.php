...
<head>
	...
	<meta name="description" content="Al Azhary Stor">
	<meta name="author" content="Al Azhary Stor">
	<meta name="generator" content="NaDo">

	<meta name="docsearch:language" content="en">
	<meta name="docsearch:version" content="4.3">

	<title>متجر الازهري</title>


	<!-- Bootstrap core CSS -->
	<link href="{{asset('frontend/newstyle/css/rtl/bootstrap.min.css')}}" rel="stylesheet">
	<!-- Style core CSS -->
	<link href="{{asset('frontend/newstyle/css/rtl/style.css')}}" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css?family=Tajawal&display=swap" rel="stylesheet"> 
	<!-- Place your kit's code here -->
    <script src="https://kit.fontawesome.com/31bb6f11e0.js"></script>
	...
	<!-- Facebook -->
	<meta property="og:url" content="https://getbootstrap.com/docs/4.3/components/navbar/">
