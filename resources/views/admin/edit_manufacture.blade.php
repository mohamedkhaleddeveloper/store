						...
						<form class="form-horizontal" method="POST" action="{{url('/update-manufacture',$manufacture_info->manufacture_id)}}">
						  ...
						  <fieldset>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge " name="manufacture_name_arabic" value="{{$manufacture_info->manufacture_name_arabic}}" />
							  </div>
							</div>
                            ...
                            <div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="manufacture_description_arabic" rows="3">{{$manufacture_info->manufacture_description_arabic}}</textarea>
							  </div>
                            </div>
							<div class="form-actions">
							  <button type="submit" class="btn btn-primary">Update Manufacture Info</button>
