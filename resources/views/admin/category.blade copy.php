						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable table-responsive">
						  <thead>
							  <tr>
								  <th>Category ID</th>
								  <th>Category Name</th>
								  <th>Category name Arabice</th>
								  <th>Category Description</th>
                                  <th>Category Description Arabice</th>
                                  <th>status</th>
                                  <th>Actions</th>
							  </tr>
						  </thead>   
						  <tbody>
							...
							<tr>
                                ...
                                <td class="center">{{$v_category->category_name_arabic}}</td>
                                <td class="center">{{$v_category->category_description}}</td>
                                <td class="center">{{$v_category->category_description_arabic}}</td>
								<td class="center">
