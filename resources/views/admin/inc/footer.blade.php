    ...
    <footer class="footer footer-static footer-light navbar-border">
      ...
      <span class="float-md-left d-block d-md-inline-block">Copyright  &copy; 2019 <a class="text-bold-800 grey darken-2" href="https://serversoft-egypt.com" target="_blank">Serve Soft </a>, All rights reserved. </span><span class="float-md-right d-block d-md-inline-blockd-none d-lg-block">Powerd By NaDo <i class="ft-heart pink"></i></span></p>
    </footer>
