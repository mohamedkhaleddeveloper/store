						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable table-responsive">
						  <thead>
							  <tr>
								  ...
								  <th>Manufacture name Arabice</th>
								  <th>Manufacture Description</th>
                                  <th>Manufacture Description Arabice</th>
                                  <th>status</th>
                                  <th>Actions</th>
							  </tr>
						  </thead>   
						  <tbody>
							...
							<tr>
                                ...
                                <td class="center">{{$v_manufacture->manufacture_name_arabic}}</td>
                                <td class="center">{{$v_manufacture->manufacture_description}}</td>
                                <td class="center">{{$v_manufacture->manufacture_description_arabic}}</td>
								<td class="center">
