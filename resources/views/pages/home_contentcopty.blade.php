					...
					<div class="left-sidebar">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								...
								<?php
								$all_published_manufacture = DB::table('tbl_brand')
								->where('brand_publication',1)
								->get();
								foreach($all_published_manufacture as $v_manufacture){
								?>
								<li><a href="{{URL::to('/product_by_manufacture/'.$v_manufacture->brand_id)}}"> <span class="pull-right">(50)</span>{{$v_manufacture->brand_name}}</a></li>
								<?php } ?>
								</ul>
							</div>
						</div><!--/brands_products-->
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="{{URL::to($v_published_product->products_image1)}}" alt="" />
