  ...
  <header>
		...
		<div class="row mx-auto">
          ...
          <?php
              ...
              ?>
                <li><a href="{{URL::to('/checkout/en')}}"><i class="fa fa-crosshairs"></i>Checkout</a></li>
              <?php }elseif($customer_id != null && $shipping_id != null){?>
                <li><a href="{{URL::to('/payment/en')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
              <?php }else{?>
                <li><a href="{{URL::to('/login-check/en')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
              <?php } ?>
            
            <li><a href="{{URL::to('/show-cart/en')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
            <?php
              $customer_id = Session::get('customer_id');  
              if($customer_id != null){
            ?>
								<li><a href="{{URL::to('/customer-logout/en')}}"><i class="fa fa-lock"></i> Logout</a></li>
								<?php }else{?>
									<li><a href="{{URL::to('/login-check/en')}}"><i class="fa fa-lock"></i> Login</a></li>
								<?php } ?>
      ...
      @if($v_category->category_parent == 0)
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="/en/{{$v_subcategory->category_name}}">{{$v_subcategory->category_name}}</a>
                @endif
                @endforeach
            </div>
        </li>
      ...
      @endforeach
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item"  href="/en/{{$v_brand->brand_name}}">{{$v_brand->brand_name}}</a>
                @endforeach
            </div>
        </li>
	  <li class="nav-item">
