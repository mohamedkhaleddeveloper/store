...
<div class="col-md-12 mt-5 mb-5 row">
	...
	<div class="col-md-4  text-center row">
		...
		<a href="{{URL::to('/view_product/'.$v_product->products_id)}}" 
		class="btn btn-outline-light bg-standerd"><i class="fas fa-cart-plus"></i> أضف لسلتك</a>
		</div>
  </div>
  @endforeach
...
<div class="col-md-12 mt-5 mb-5 row">
	...
	<div class="col-md-4  text-center row">
		...
		<a href="{{URL::to('/view_product/'.$v_product->products_id.'/en')}}"
		 class="btn btn-outline-light bg-standerd"><i class="fas fa-cart-plus"></i> Add to Cart</a>
		</div>
  </div>
  @endforeach
