      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item"><a class="navbar-brand" href="{{url('/dashboard/en')}}"><img class="brand-logo" alt="robust admin logo" src="{{asset('backend/app-assets/images/logo/logo-light-sm.png')}}">
                <h5 class="brand-text">AlAzhary Store</h5></a></li>
        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">         
              <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="en" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-gb"></i><span>English</span><span class="selected-language"></span></a>
                <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="ar"><i class="flag-icon flag-icon-eg"></i> عربي</a></div>
              </li>
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="avatar avatar-online"><img src="{{asset('backend/app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span><span class="user-name">{{ Session::get('admin_name')}}</span></a>
                <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="user-profile.html"><i class="ft-user"></i> Edit Info </a> <div class="dropdown-divider"></div><a class="dropdown-item" href="{{URL::to('/logout')}}"><i class="ft-power"></i> Log Out </a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
			<li class="nav-item">
				<a href="{{url('/dashboard/en')}}">
					<i class="icon-home"></i><span class="menu-title" data-i18n="nav.changelog.main">Home</span>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{url('/category/en')}}">
					<i class="icon-layers"></i><span class="menu-title" data-i18n="nav.changelog.main">Category</span>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{url('/company/en')}}">
					<i class="icon-bulb"></i><span class="menu-title" data-i18n="nav.changelog.main">Company</span>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{url('brand/en')}}">
					<i class="icon-drawer"></i><span class="menu-title" data-i18n="nav.changelog.main">Brand</span>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{url('product/en')}}">
					<i class="icon-screen-tablet"></i><span class="menu-title" data-i18n="nav.changelog.main">Products</span>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{url('offer/en')}}">
